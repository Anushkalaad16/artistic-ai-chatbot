...
export default function SignupPage() {
  ...
  const validateFields = () => {
    ...
    if (!email.trim()) {
      ...
      newErrors.email = "Email domain must contain 'gmail'";
      isValid = false;
  ...
  const bgColor = isDark ? colors.dark.background : colors.white;
  ...
  return (
    ...
    >
      ...
      <div className={`w-full max-w-4xl relative transition-all duration-700 ${!isPageLoaded ? 'blur-md' : 'blur-0'}`}>
        <div className="relative z-20 w-1/2">
          <div
            ...
            style={{ backgroundColor: cardBg, borderRight: `1px solid ${borderColor}`, boxShadow: `20px 0 40px rgba(0,0,0,0.05)` }}
          >
            {/* Back Button */}
            <button
              onClick={handleBack}
            ...
            <div className="flex items-center gap-3 mb-10">
              <div className="w-14 h-14 rounded-full flex items-center justify-center">
                <img src="../../public/chaticon.png" alt="Artistic AI Logo" className="w-10 h-10 object-contain transition-all duration-300" />
              </div>
              <div>
                <h1 className="text-4xl font-black" style={{ color: textColor }}>Create Account</h1>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  style={{ backgroundColor: isDark ? '#2C2C2C' : '#FFFFFF', color: textColor, border: `1px solid ${borderColor}` }}
                />
            ...
            <p className="text-center mt-6" style={{ color: textSecondary }}>
              ...
              <button onClick={() => navigate('/login')} className="font-semibold hover:underline transition-colors" style={{ color: colors.orange }}>
                Log in
              </button>
            </p>
          </div>
      ...
      <div className="absolute right-0 top-0 w-1/2 h-full z-10">
        <div className="h-full flex items-center justify-center p-12 rounded-r-3xl transition-all duration-700" style={{ backgroundColor: bgColor }}>
          <div className="relative w-full max-w-md">
            <video
              ...
              style={{ boxShadow: `0 20px 40px rgba(0,0,0,0.1)`, border: `2px solid ${borderColor}`, animation: 'pulseBlur 3s infinite ease-in-out' }}
            >
              <source src="/public/ai-animation-Picsart-BackgroundRemover.mp4" type="video/mp4" />
